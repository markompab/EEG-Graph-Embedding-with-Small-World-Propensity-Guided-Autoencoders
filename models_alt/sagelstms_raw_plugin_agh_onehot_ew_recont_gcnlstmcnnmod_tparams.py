...
class SageConvLSTMRawPluginAGHOneHotWRecGLCNNTParamsMode(torch.nn.Module):
    def __init__(self, out_channels, lenin=8500,  BS=16):
        ...
        self.gcn1 = SAGEConv(in_channels=640, out_channels=480, aggr='lstm', normalize=True)
        ...
        self.gcn2 = SAGEConv(in_channels=320, out_channels=250, aggr='lstm', normalize=True)
        ...
        self.gcn3 = SAGEConv(in_channels=180, out_channels=135, aggr='lstm', normalize=True)
        ...
        self.gcn4 = SAGEConv(in_channels=90, out_channels=70, aggr='lstm', normalize=True)
        ...
        #
        self.decgcn2 = SAGEConv(in_channels=50, out_channels=180, aggr='lstm', normalize=True)
        self.decgcn4 = SAGEConv(in_channels=180, out_channels=640, aggr='lstm', normalize=True)
