...
class GCNLSTMRawPluginHandedDiscrete(torch.nn.Module):
    def __init__(self, out_channels, lenin=8500,  BS=16):
        ...
        self.fcn1  = Linear(in_channels=51, out_channels=32)
    ...
    def forward(self, x_in, edge_index, gender):
        ...
        x = torch.concatenate([x, gender], dim=1)
    ...
    def getLabel(self):
        lbl = "GCNLSTMRawHandednessPluginDiscrete"
        return lbl