...
from torch_geometric.nn import GCNConv, Linear, MLP, global_add_pool, SAGEConv, GATConv


class GATConvLSTMRawPluginAGHOneHotWRecGLCNN(torch.nn.Module):
    def __init__(self, out_channels, lenin=8500,  BS=16):
        ...
        self.gcn1 = GATConv(in_channels=640, out_channels=480)
        ...
        self.gcn2 = GATConv(in_channels=320, out_channels=250)
        ...
        self.gcn3 = GATConv(in_channels=180, out_channels=135)
        ...
        self.gcn4 = GATConv(in_channels=90, out_channels=70)
        ...
        #
        self.decgcn2 = GATConv(in_channels=50, out_channels=180)
        self.decgcn4 = GATConv(in_channels=180, out_channels=640)
    ...
    def getLabel(self):
        lbl = "GATConvLSTMRawPluginAGHOneHotWRecGLCNN"
        return lbl