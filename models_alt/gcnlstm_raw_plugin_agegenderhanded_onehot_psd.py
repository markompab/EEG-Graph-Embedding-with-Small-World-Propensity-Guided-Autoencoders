...
class GCNLSTMRawPluginAGHOneHotPsd(torch.nn.Module):
    def __init__(self, out_channels, lenin=8500,  BS=16):
        ...
        self.gcn3 = GCNConv(in_channels=129, out_channels=90)
    ...
    def getLabel(self):
        lbl = "GCNLSTMRawPluginAGHOneHotPSD"
        return lbl