...
class GCNLSTMRawAgePluginDiscrete(torch.nn.Module):
    def __init__(self, out_channels, lenin=8500,  BS=16):
        ...
        self.fcn1  = Linear(in_channels=53, out_channels=32)
    ...
    def forward(self, x_in, edge_index, age):
        ...
        x = torch.concatenate([x, age], dim=1)
